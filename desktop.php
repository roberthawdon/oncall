...
<p><a href="<?php echo "mailto:".getoption("escalate_email"); ?>" class="button-link button-colour-red" data-rel="external">Escalate to on call*</a></p>
</div>
</div>
...
<p>User ID: <?php echo $_COOKIE['user']?> <br /> Auth Test: <?php echo getauth($_COOKIE['user'])[2]?></p>
